...
CodeEditor::CodeEditor(QWidget *parent,
                       ...
                       QColor BlockNumberColor,
                       QColor LineColor) : QPlainTextEdit(parent), m_completer(nullptr)
{
    ...
    blockNumberColor = BlockNumberColor;
    lineColor = LineColor;
...
void CodeEditor::lineNumberAreaPaintEvent(QPaintEvent *event)
{
    ...
    painter.fillRect(event->rect(),lineNumberAreaColor); // 行号区域背景色
    ...
    while (block.isValid() && top <= event->rect().bottom()) {
        if (block.isVisible() && bottom >= event->rect().top()) {
            ...
            painter.setPen(blockNumberColor); // 行号颜色
